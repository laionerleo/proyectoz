                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table  id="table_data" class="table table-striped table-advance table-hover" cellspacing="0" width="100%">
	                  	  	 <center><h3><i class=""></i>Listado de Clientes</h3></center>
	                  	  	  <hr>
                              <thead>
                              <tr>
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a data-toggle="modal" value="" class="btn btn-danger btn-floating" data-target="#modificarModal-{{ $value->id }}" title="Editar">
