          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li ><a  href="{{ url('/form_component')}}">Registrar Servicio</a></li>
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a  href="{{ url('/registrar_Asignacio_trabajo')}}">Registrar Trabajo</a></li>
                      <li><a  href="{{ url('/listar_Asignar_Trabajo')}}">Listar Trabajo</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<center><h3><i class="fa fa-map-marker"></i>Bienvenido Asignacion De Trabajos</h3></center>
          	<div class="row mt">

          		<! -- DATE PICKERS -->
	          	<div class="col-lg-12">
		          	<div class="form-panel">
		                  <form method="POST" action="registrar_Asignacio_Nuevo" class="form-horizontal style-form">
                           @csrf
                          <center><h3><i class=""></i>Registro Administracion Servicios</h3></center>   
                            <div class="form-group has-success">
                            <label class="col-lg-2 control-label">Servicio Solicitado</label>
                                <div class="col-lg-10">
                                    <select type="text" name="id" id="id" class="form-control select">
                                        <option value="">Solicitud De Los Servicios</option>
                                        @foreach($administrarServicio as $value)
                        <option value="{{ $value->id }}">{{ $value->Desscripcion }}</option>
                                        @endforeach
                            ...
                            <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Ubicacion Descripcion</label>
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Ubicacion Descripcion"  name="Direccion" id="Direccion" class="form-control">
                                    <p class="help-block">Ubicacion Descripcion</p>
                                </div>
                            </div>
             ...
             {{--  <div class="row mt">
              ...
              <div class="row mt">
          	  ...
          	  <!--ADVANCED FILE INPUT-->
                <h3><i class="fa fa-angle-right"></i>Registrar Del Costo Del Servicio</h3>
              <div class="row mt">
                  <div class="col-lg-12">
                      <div class="form-panel">
                          <form action="#" class="form-horizontal style-form">
                            ...
                            <div class="form-group has-success">
                                <label class="col-lg-2 control-label">Trabajadores de la Empresa</label>
                                <div class="col-lg-10">
                              ...
                              <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button class="btn btn-theme" type="submit">Registrar Asignacion</button>
                                    <button class="btn btn-theme04" type="button">Cancelar Asignacion</button>
                                </div>
