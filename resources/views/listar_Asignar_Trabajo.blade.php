          ...
          <div id="sidebar"  class="nav-collapse ">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li><a  href="{{ url('/listar_servicios')}}">Listar Solicitudes</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;" >
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table  id="table_data" class="table table-striped table-advance table-hover" cellspacing="0" width="100%">
                            <center><h3><i class=""></i>Lista De La Asignacion</h3></center>
                            <hr>
                              <thead>
                              <tr>
                                  <th><i class="fa fa-cogs"></i>Servicio</th>
                                  <th><i class='fa fa-male'></i>Empleado</th>
                                  <th><i class="fa fa-map-marker"></i>Direccion</th>
                                  <th><i class='fa fa-calendar'></i> Fecha</th>
                                  <th><i class='fa fa-window-minimize'></i>Estado</th>
                              ...
                              <tbody>
                                @foreach ($AsignarTrabajo as $value)
                                <tr>
                                    @foreach ($administrarServicio as $AdministrarServicios)
                                    @if ( $value->id_servicio  == $AdministrarServicios->id)
                                    <td>{{$AdministrarServicios->Desscripcion}}</td>
                                    @endif
                                    @endforeach
                                 ...
                                 @include('modificar_Asignacion_Trabajos')
                                @endforeach
                              </tbody>
                          </table>
