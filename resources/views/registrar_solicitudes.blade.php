  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <center><h2><i class=""></i>Bienvenido</h2></center>
          	<div class="row mt">

          		<! -- DATE PICKERS -->
	          	<div class="col-lg-12">
		          	<div class="form-panel">
		                  <form method="POST" action="/registrar_solicitudes_Nuevo" class="form-horizontal style-form">
                           @csrf
                          <center><h3><i class=""></i>Registrar Servicios</h3></center>
                            ...
                            <label class="col-lg-2 control-label"> Servicio</label>
                                <div class="col-lg-10">
                                    <select type="text"   name="id_servicio" id="id_servicio" class="form-control select">
                                        <option value="">Los Servicio</option>
                                    ...
                                    <p class="help-block">Los diferente Servicio</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Desscripcion"  name="Desscripcion" id="Desscripcion" class="form-control">
                                    <p class="help-block">Descripcion Del Servcio</p>
                                </div>
                            </div>
             ...
             {{--  <div class="row mt">
              ...
              <div class="row mt">
          	  ...
          	  <!--ADVANCED FILE INPUT-->
               <center><h3><i class=""></i>Registrar Del Costo Del Servicio</h3></center> 
              <div class="row mt">
                  <div class="col-lg-12">
                      <div class="form-panel">
                          <form action="#" class="form-horizontal style-form">
                            ...
                            <label class="col-lg-2 control-label">Costo del Servicio</label>
                                <div class="col-lg-10">
                                    <select type="text"   name="costo_servicio" id="costo_servicio" class="form-control select">
                                        <option value="">Costo un Servicio</option>
                                        @foreach($servicios as $value)
                                            <option value="{{ $value->id }}">{{ $value->costo_servicio}}</option>
                                        @endforeach
                                    ...
                                    <p class="help-block">Costo Del Servicio</p>
                                </div>
                            </div>
                              ...
                              <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button class="btn btn-theme" type="submit">Registrar Solicitud</button>
                                    <button class="btn btn-theme04" type="button">Cancelar Solicitud</button>
                                </div>
                            </div>
                          </form>
                      </div><!-- /form-panel -->
