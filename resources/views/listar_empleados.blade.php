                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table  id="table_data" class="table table-striped table-advance table-hover" cellspacing="0" width="100%">
	                  	  <center><h3><i class=""></i>Listado de Empleados</h3></center>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  ...
                                  <th><i class=""></i> Nro Carnet</th>
                                  <th><i class=""></i> Direccion  </th>
                                  <th><i class=""></i> Telefono</th>
                                  <th><i class=""></i> Ocupacion</th>
                                  <th><i class=""></i> Valor x Hr</th>
