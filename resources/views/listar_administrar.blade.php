              ...
              <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                  ...
                  <ul class="sub">
                    ...
                    <li ><a  href="{{ url('/listar_administrar')}}">Listar Servicios</a></li>
                  </ul>
              </li>
              <li class="sub-menu">
                <a class="active" href="javascript:;" >
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table  id="table_data" class="table table-striped table-advance table-hover" cellspacing="0" width="100%">
	                  	  	<center><h3><i class=""></i>Listado Administrar Solicitudes</h3></center>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th><i class="fa fa-bookmark"></i>Servicio</th>
                                  <th><i class="fa fa-bookmark"></i>Costo Servicio S</th>
