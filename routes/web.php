...
Route::get('/gmaps', ['as ' => 'google_maps', 'uses' => 'GmapsController@index']);
Route::post('/login', 'Auth\LoginController@login')->name('login');
Route::post('/logout', 'Auth\LoginController@logout')->name('logout');


Route::get('vistamapaempleado', 'GmapsController@VerMapaUbicacion');//leo





//Rutas de Usuario  AsiganarTrabajoControlle
Route::group(['Middleware' => 'EsAdmin'], function () {
    ...
    Route::get('listar_administrar', 'AdministrarController@index')->name('listar_administrar');

     Route::get('listar_Asignar_Trabajo', 'AsiganarTrabajoControlle@index')->name('listar_Asignar_Trabajo');
    ...
    Route::post('updateAdministracion/{id}','AdministrarController@update')->name('updateAdministracion');

    Route::post('updateAsignacion/{id_asignacio}','AsiganarTrabajoControlle@update')->name('updateAsignacion');
    ...
    Route::get('/registrar_solicitudes', function () {
        ...
        $servicios=Servicio::all();
        $empleados=Empleado::all();
         return view('registrar_solicitudes',['usuario_logeado'=>$usuario_logeado,'servicios'=>$servicios,'empleados'=>$empleados]);
    });


    Route::get('/registrar_Asignacio_trabajo', function () {
        $usuario_logeado=User::find(Auth::User()->id);
        $administrarServicio=AdministrarServicio::all();
        $empleados=Empleado::all();
        return view('registrar_Asignacio_trabajo',['usuario_logeado'=>$usuario_logeado,'administrarServicio'=>$administrarServicio,'empleados'=>$empleados]);
    });
    ...
    Route::resource('registrar_solicitudes_Nuevo', 'AdministrarController');
    Route::resource('registrar_Asignacio_Nuevo', 'AsiganarTrabajoControlle');
